...
var name = 'turn-on-low-seat-warning-${deploymentName}'
var eventType = 'seat_warning_level_reached'
var triggerName = 'When_subscription_low_seat_warning_level_is_reached'
            ...
            schema: {
              properties: {
                ...
                seat: {
                  properties: {
                    created_utc: {
                      title: 'Seat provided date/time (UTC)'
                    }
                    expires_utc: {
                    ...
                    occupant: {
                      properties: {
                        email: {
                          title: 'Seat occupant email'
                        }
                        user_id: {
                          title: 'Seat occupant ID'
                        }
                        user_name: {
                    ...
                    seat_type: {
                      description: 'Supported types are [limited] or [standard]'
                      title: 'Seat type'
                    }
                  }
                  type: 'object'
