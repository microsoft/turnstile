...
namespace Turnstile.Core.Models.Configuration
{
    public class PublisherConfiguration
    {
        ...
        [JsonProperty("claims_config")]
        [JsonPropertyName("claims_config")]
        public ClaimsConfiguration? ClaimsConfiguration { get; set; } = new ClaimsConfiguration();
        ...
        public IEnumerable<string> Validate()
        {
            ...
            if (ClaimsConfiguration == null)
            {
                errors.Add("[claims_config] is required.");
            }
            else
            {
                errors.AddRange(ClaimsConfiguration!.Validate().Select(e => $"Publisher configuration [claims_config]: {e}"));
            }
