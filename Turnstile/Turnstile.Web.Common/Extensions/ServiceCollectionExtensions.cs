...
namespace Turnstile.Web.Common.Extensions
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddApiClients(this IServiceCollection services, string userAgent)
        {
            ...
            services.AddHttpClient(HttpClientNames.TurnstileApi, h => ConfigureApiClient(h, userAgent))
        ...
        private static void ConfigureApiClient(HttpClient client, string userAgent)
        {
